...
![Solarized+Powerline](https://raw.github.com/dmowcomber/powerline-go/master/preview.png)
...
[releases tab](https://github.com/dmowcomber/powerline-goreleases)
...
```bash
go get -u github.com/dmowcomber/powerline-go
```
...
`$GOPATH/src/github.com/dmowcomber/powerline-go`, you'll instead see `@GOPATH-GH >
